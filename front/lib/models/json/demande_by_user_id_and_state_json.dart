...
class DemandeByUserIdAndStateJson extends AbstractJsonResource {
  String? message;
  int? status;
  List<Data>? data;

  DemandeByUserIdAndStateJson({this.message, this.status, this.data});

  DemandeByUserIdAndStateJson.fromJson(Map<String, dynamic> json) {
